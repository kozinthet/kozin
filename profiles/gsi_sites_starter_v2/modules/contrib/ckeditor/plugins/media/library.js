...
(function ($) {
  ...
  Drupal.settings.ckeditor.plugins['media'] = {
    ...
    createTag: function (imgNode) {
      ...
      // Remove extra attribs
      delete mediaAttributes['field_file_image_alt_text[und][0][value]'];
      delete mediaAttributes['field_file_image_title_text[und][0][value]'];
      delete mediaAttributes['format'];
      delete mediaAttributes['src'];
